...
The aim of this lesson is to take a look at some key statistical ideas in the context of R, with a focus on the sorts of areas typically employed in life sciences research. Given time constraints, this is not a fully-fledged statistics course, but will demonstrate how to explore and use the basic principles within R. The topics touched upon include,
